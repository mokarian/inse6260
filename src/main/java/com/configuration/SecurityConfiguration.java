...
//        storeStudentToDatabase("Freyja", "Jökulsdóttir", "freyja@concordia.ca", STUDENT, 2);
    ...
    private Set<Course> getCourses() {
       ...
       course1.setSemester(Semester.FALL_2017.name());
        course2.setSemester(Semester.FALL_2017.name());
        courses.add(course1);
        courses.add(course2);
        return courses;
    }
...
//        courseHistory.setCourse_id(1);
      ...
      courseHistory.setSemester(Semester.FALL_2016.name());
...
//        courseHistory.setCourse_id(2);
        ...
        courseHistory1.setSemester(Semester.FALL_2016.name());
        ...
        courseHistory2.setSemester(Semester.WINTER_2017.name());
        ...
        courseHistory3.setSemester(Semester.WINTER_2017.name());
